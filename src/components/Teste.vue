    ...
    async getMoeda() {
      ...
      if (this.$root.authenticated) {
        ...
        try {
          ...
          console.log("id: " + this.id + " id_stock " + this.teste[0].id+ " Symbol: " + this.teste[0].stock_symbol + " Nome: " + this.name + " Volume: " + this.volume  + " Preço: " + this.bid, "tipo: " + this.type) 
        } catch (error) {
